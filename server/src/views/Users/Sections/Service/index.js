...
import { SERVICE_STEP, TYPE } from "utils/enum";
...
function SectionTabs(props) {
  ...
  console.log("SectionTabs -> step", step)
  ...
  switch (step) {
    case SERVICE_STEP.SELECT:
      Content = (
        <MainForm setStep={setStep} setType={setType} type={type} step={step} />
      );
      break;
    case SERVICE_STEP.FILL_INFORMATION:
      Content = renderForm(type);
      break;
    case SERVICE_STEP.LOADING:
      Content = LoadingComponent;
      break;
    case SERVICE_STEP.APPROVE:
      Content = (
        <ApproveForm
          setStep={setStep}
          step={step}
          ...
          type={type}
          value={value}
          validatorList={userlist["validator"]}
          setResult={setResult}
        />
      );
      break;
    case SERVICE_STEP.CONFIRM_TRANSATION:
      Content = (
        <Loading
          showButton={false}
        />
      ...
      break;
      case SERVICE_STEP.MAKE_PAYMENT:
      Content = (
        <Payment
        setStep={setStep}
        step={step}
      ...
      break;
      case SERVICE_STEP.CONFIRM_PAYMENT:
      Content = (
        <Loading
          showButton={false}
        />
      ...
      break;
    case SERVICE_STEP.COMPLETE:
      Content = (
        <Success
          handleBack={() => {
            props.history.push("/user/3");
          }}
        />
      );
      break;
